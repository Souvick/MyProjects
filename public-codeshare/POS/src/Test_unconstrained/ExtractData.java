...
public class ExtractData {
    ...
    public void extractWindow_file1(VariablesList vl){
        ...
        HashMap<String,String> hm_en2 = new HashMap<>();
            ...
            while(scanner.hasNextLine()){
                ...
                if(st.countTokens()>1)
                {
                    ...
                    if(lang.equalsIgnoreCase("en")){
                        ...
                        else if(hm_en2.containsKey(word)){
                            post = hm_en2.get(word);
                            s1+=count+"\t"+word+"\t"+post+"\n";
                        }
                        else{
            ...
            while(scanner.hasNextLine()){
                ...
                if(st.countTokens()>1)
                {
                    ...
                    if(lang.equalsIgnoreCase("E")){
                        ...
                        else if(hm_all.containsKey(word)){
                            post = hm_all.get(word);
                            s1+=count+"\t"+word+"\t"+post+"\n";
                        }
                        else{
                            System.out.println(count+"\t"+word);
