...
public class PAN_AI_2015 {
   ...
   public PAN_AI_2015(){
    ...
    public static void main(String[] args) throws Exception {
        ...
        output_path= args[3]; //output path from command line argument
        pan.takeInputAllLanguage(input_path);
        
    }
    
    void takeInputAllLanguage(String input_path) throws FileNotFoundException, IOException, Exception
    {   //redirect to each language folder
      File dir = new File(input_path);
        ...
        if (children == null) {
            ...
            {
                takeInputSingleLanguage(input_path);
            }
        }
        Weka weka= new Weka();
        weka.createTrainingFeatureFile(op, output_path);
        op="";
    }
    
    void takeInputSingleLanguage(String input_path) throws FileNotFoundException, IOException, Exception
    {
        String language="";
        File dir = new File(input_path);
        String[] children = dir.list();
    ...
    void takeInput(String language, String input_path) throws FileNotFoundException, IOException, Exception
    ...
    String checkAnswer(String auth_id)
    {
        String result="Y";
        StringTokenizer tokenizer= new StringTokenizer(yn);
        while(tokenizer.hasMoreTokens())
        {
            if(tokenizer.nextToken().equals(auth_id))
            {
